...
> Tips:
> Example of how the components interact with each other and how to embed the
> library can be found in the `dist/embed` directory after the library is built
> with `npm run build:lib` first.
