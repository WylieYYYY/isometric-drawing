...
It attempts to mimic the drawing style on physical grid paper.
...
To build a static site, replace the last step with `npm run build` and the static site content will be built in the `dist` directory.
